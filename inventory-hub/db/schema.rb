...
ActiveRecord::Schema[7.0].define(version: 2023_08_08_144551) do
  create_table "inventories", force: :cascade do |t|
    ...
    t.index ["shoe_store_id"], name: "index_inventories_on_shoe_store_id"
  end
  ...
  create_table "shoe_stores", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_shoe_stores_on_name", unique: true
  end

  add_foreign_key "inventories", "shoe_models"
  add_foreign_key "inventories", "shoe_stores"
end
