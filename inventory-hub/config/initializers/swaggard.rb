...
Swaggard.configure do |config|
  ...
  config.additional_parameters = [{ key: 'Accept', type: 'header', value: 'application/json' }]
  ...
  config.contact_email = "alymenbr@gmail.com"
  ...
  config.description = "Potloc's exercise - Mr. Aldo's inventory hub"
  ...
  config.title = "Aldo's Inventory Hub"
